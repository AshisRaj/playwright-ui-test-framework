...
test.describe('sauceDemo Login Tests', () => {
  test(
    'successful login' + ' @allure.label.feature:Authentication' + ' @allure.label.story:Login',
  ...
  test(
    'reuse session storage' + ' @allure.label.feature:Authentication' + ' @allure.label.story:Login',
    { tag: ['@regression'] },
    async ({ page, loginPage }) => {
  ...
  test.use({ storageState: storageStatePath }); // Automatically load storage state if it exists
  test(
    'logout and clear session storage' + ' @allure.label.feature:Authentication' + ' @allure.label.story:Login',
